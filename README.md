...
You can also import additional plate-based Sanger sequencing data using
...
then you can run **scFindBCRClones()**, adding **only_heavy = TRUE** if
...
Also export all intermediate files (including sequences that fail
